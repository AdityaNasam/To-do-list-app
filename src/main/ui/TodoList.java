...
public class TodoList extends JPanel implements ListSelectionListener {
...
//    }
    ...
    private void init() {
        ...
        AddToList addToList1 = new AddToList(addToList);
        ...
        deleteFromList.addActionListener(new DeleteFromList());
